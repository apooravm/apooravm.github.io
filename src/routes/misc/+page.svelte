...
<div class="columns-2 px-2 sm:columns-3 sm:px-4 md:px-6 lg:px-20 lg:columns-4 py-2 gap-x-2">
    {#each notes as note}
        <div class=" duration-200 bg-neutral-900 hover:shadow-pink-500 border-2 my-1 sm:my-1 text-[12px] sm:text-[14px] px-2 pt-2 sm:pt-3 pb-4 sm:pb-10 hover:bg-neutral-800 cursor-pointer rounded-lg border-pink-500 inline-block w-full">
            {note}
        </div>
    {/each}
</div>
